...
<div className="flex flex-col sm:flex-row gap-4">
  ...
  <a href="/file-claim" className="bg-[#B8893D] hover:bg-[#B8893D] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 flex items-center justify-center">
    ...
    View Resources
              ...
              return (
                <div key={resource.title} className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div className="bg-gray-900 text-white p-6">
                    ...
                    <span className="inline-block bg-[#B8893D] text-white px-3 py-1 rounded-full text-sm font-semibold">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-5 gap-6 mb-8">
            {processSteps.map((step, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-[#B8893D] font-medium text-sm mb-2">{step.time}</div>
          ...
          <div className="bg-[#FBF5EB] border-l-4 border-[#B8893D] p-6 rounded-r-lg">
            <div className="flex items-start space-x-3">
              <AlertCircle className="w-6 h-6 text-[#B8893D] mt-0.5 flex-shrink-0" />
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <span className="inline-block mt-2">
                    <a href="tel:+15155817187" className="text-[#B8893D] hover:text-[#B8893D] font-semibold underline">
              ...
              <div className="space-y-6">
                {supportSteps.map((step, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#B8893D] to-[#B8893D] rounded-full flex items-center justify-center flex-shrink-0">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-4xl mx-auto">
        ...
        <a href="/file-claim" className="w-full sm:w-auto bg-[#B8893D] hover:bg-[#B8893D] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 flex items-center justify-center whitespace-nowrap">
          <FileText className="mr-2 w-5 h-5" />
          Trucking Claim Form
        </a>
