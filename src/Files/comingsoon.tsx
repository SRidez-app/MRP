      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="inline-block mb-8 px-6 py-3 rounded-full" style={{
            ...
            border: '2px solid rgba(212, 176, 107, 0.3)'
          }}>
            <span className="text-xl md:text-2xl font-bold tracking-wider" style={{ 
              color: '#D4B06B',
              textShadow: '0 0 20px rgba(212, 176, 107, 0.5)'
            }}>
              COMING SOON
            </span>
          </div>
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-lg md:text-xl text-white leading-relaxed max-w-3xl mx-auto" style={{ 
              ...
              <strong style={{ color: '#D4B06B' }}> Fast quotes and expedited service</strong> - we protect what builds America.
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="inline-block rounded-2xl p-8 shadow-2xl max-w-md mx-auto" style={{
              ...
              border: '1px solid rgba(212, 176, 107, 0.15)',
              ...
              <button 
                ...
                className="w-full bg-[#B8893D] hover:bg-[#A87A32] text-white px-8 py-4 rounded-lg text-lg font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Request Quote Now
              </button>
              
              <p className="text-white/60 text-xs mt-4">
                Email us at <a href="mailto:quotes@moxieriskpartners.com" className="text-[#D4B06B] hover:text-[#E5CFA5] underline">quotes@moxieriskpartners.com</a>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-8 pt-6 pb-6 px-6 border-t border-white/20 justify-center rounded-lg max-w-2xl mx-auto" style={{
            ...
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold" style={{ 
                color: '#D4B06B', 
                textShadow: '0 0 8px rgba(212, 176, 107, 0.4)' 
              }}>24/7</div>
