  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div id="information-collected" className="space-y-6">
            <div className="flex items-start space-x-4 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-[#B8893D] to-[#B8893D] rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <ul className="space-y-2">
                      {category.items.map((item, idx) => (
                        <li key={idx} className="flex items-start space-x-2">
                          <CheckCircle className="w-4 h-4 text-[#B8893D] mt-1 flex-shrink-0" />
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={index} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                      <AlertTriangle className="w-5 h-5 text-[#B8893D] mt-0.5 flex-shrink-0" />
                      <div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={index} className="flex items-start space-x-2">
                      <Shield className="w-5 h-5 text-[#B8893D] mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">{item}</span>
                    </li>
                  ))}
                </ul>
                ...
                {privacyRights.map((right, index) => {
                  ...
                  return (
                    <div key={index} className="text-center p-6 bg-white rounded-xl border border-gray-200">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#B8893D] to-[#B8893D] rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={index} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                      <Clock className="w-5 h-5 text-[#B8893D] mt-0.5 flex-shrink-0" />
                      <div>
                        <span className="font-bold text-gray-900">{item.title}</span>
                        <span className="text-gray-700"> {item.desc}</span>
                      </div>
