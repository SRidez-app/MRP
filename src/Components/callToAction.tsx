...
const CallToAction: React.FC = () => {
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 25% 25%, rgba(255, 107, 53, 0.15) 0%, transparent 50%),
                           radial-gradient(circle at 75% 75%, rgba(255, 170, 133, 0.1) 0%, transparent 50%)`
        }}></div>
      </div>
  ...
  our clients need to focus on what they do best.&quot;
          ...
          <div className={`${isVisible ? 'animate-fade-in-up' : 'opacity-0'} delay-200`}>
            <div className="bg-gradient-to-br from-gray-900 via-black to-gray-800 rounded-3xl shadow-2xl p-8 lg:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    <div key={index} className="flex items-center">
                      <div className="flex-shrink-0 w-6 h-6 bg-green-400/20 border border-green-400/30 rounded-full flex items-center justify-center mr-3">
                ...
                <div className="space-y-4">
                  ...
                  <button 
                    className="w-full border-2 border-gray-600 hover:border-orange-500 text-gray-300 hover:text-orange-400 py-4 px-6 rounded-xl font-bold text-lg transition-all duration-200 hover:bg-orange-500/10 flex items-center justify-center group"
                    suppressHydrationWarning
                  >
                    Get a Quote
                    <svg className="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`mt-16 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'} delay-400`}>
          <div className="bg-gray-100 border border-gray-200 rounded-2xl p-6 shadow-sm">
            <div className="flex flex-wrap gap-8 justify-center text-center">
              <div>
                <div className="text-2xl md:text-3xl font-bold mb-2 text-orange-600">24/7</div>
                <div className="text-gray-700 text-sm font-medium">Claims Support</div>
              </div>
              <div>
                <div className="text-2xl md:text-3xl font-bold mb-2 text-orange-600">48</div>
                <div className="text-gray-700 text-sm font-medium">States</div>
              </div>
              <div>
                <div className="text-2xl md:text-3xl font-bold mb-2 text-orange-600">100%</div>
                <div className="text-gray-700 text-sm font-medium">Compliant</div>
              </div>
            </div>
          </div>
        </div>
