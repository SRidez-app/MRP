            ...
            {/* Action Buttons */}
                <div className="space-y-4">
                  <a 
                    ...
                    className="w-full bg-[#B8893D] hover:bg-[#B8893D] text-white py-4 px-6 rounded-xl font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center group"
                  >
