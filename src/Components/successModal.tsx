              ...
              {[...Array(60)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: ['#B8893D', '#D4B06B', '#4ade80', '#3b82f6', '#f59e0b', '#ef4444', '#8b5cf6', '#fbbf24'][Math.floor(Math.random() * 8)]
                  }}
                />
              ))}
              ...
              {[...Array(20)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: ['#B8893D', '#D4B06B'][Math.floor(Math.random() * 2)]
                  }}
                />
              ))}
            </div>
          ...
          <div className="text-center">
            ...
            <div className="text-left">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <a href="/trucking-insurance" className="text-[#B8893D] hover:text-[#A87A32] hover:underline">
                  Trucking Insurance
                </a>
                <a href="/construction" className="text-[#B8893D] hover:text-[#A87A32] hover:underline">
                  Construction
                </a>
                <a href="/nonprofit" className="text-[#B8893D] hover:text-[#A87A32] hover:underline">
                  Nonprofit
                </a>
                <a href="/manufacturing" className="text-[#B8893D] hover:text-[#A87A32] hover:underline">
                  Manufacturing
                </a>
                <a href="/workers-comp" className="text-[#B8893D] hover:text-[#A87A32] hover:underline">
                  Workers Comp
                </a>
                <a href="/claims" className="text-[#B8893D] hover:text-[#A87A32] hover:underline">
                  Claims Support
                </a>
              </div>
            </div>
